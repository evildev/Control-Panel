...
{if $do eq "pre-upload"}
<div class="contentspacer"></div>
<form enctype="multipart/form-data" action="admin.php?m=eviladmin&amp;act=settings&amp;do=upload&amp;sid={$sid}" method="post" name="sgcopy" id="sgcopy">
...
{/if}
<form action="admin.php?m=eviladmin&amp;act=settings&amp;do=edit&amp;sid={$sid}" method="post" name="settings" id="settings">
  <div class="contentbox">
    ...
    <div class="contenttext">
      ...
      <div style="float:left; width:150px; padding:10px;">&nbsp;&nbsp;&nbsp;( <a class="dark" href="admin.php?m=eviladmin&amp;act=settings&amp;do=pre-upload&amp;sid={$sid}">{$lang.eviladmin_upload_message}!</a> )</div>
      <div class="clear">&nbsp;</div>
      <div style="float:left; width:250px; padding:5px;">{$lang.virtualserver_hostbanner_gfx_interval}:</div>
      <div style="float:left; width:250px; padding:5px;">
...
{if $do eq "pre-edit"}
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=user&amp;do=edit&amp;sid={$sid}&amp;uid={$uid}" method="post" name="user" id="user">
  <input type="hidden" id="save" name="save" value="1" />
  <div class="contentbox">
...
<div class="contentbox">{foreach from=$clientdblist item=ul name=ul}
  <div class="contenttable" style="background-color:{cycle values="#f7f7f7,#e2f0f1"};">
    ...
    <div style="float:left; width:55px;"><a class="dark" href="admin.php?m=eviladmin&act=user&do=pre-edit&sid={$sid}&uid={$ul.cldbid}"><img src="./templates/{$theme}/images/pencil.png" alt="{$lang.eviladmin_info_user_edit}" title="{$lang.eviladmin_info_user_edit}" /></a>&nbsp;&nbsp;&nbsp;<a class="dark" ondblclick="document.location.href='admin.php?m=eviladmin&act=user&do=delete&sid={$sid}&uid={$ul.cldbid}'" style="cursor:pointer;"><img src="./templates/{$theme}/images/delete.png" alt="{$lang.eviladmin_info_user_delete}"  title="{$lang.eviladmin_info_user_delete}" /></a></div>
    <div class="clear"> </div>
  </div>
  {/foreach} </div>
<div class="contentbox">
...
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=message&amp;do=send&amp;sid={$sid}" method="post" name="message" id="message">
  <div class="contentbox">
...
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=user&amp;sid={$sid}&amp;find=1&amp;methode=databaseid" method="post" name="user" id="user">
  <input type="hidden" id="save" name="save" value="1" />
  <div class="contentbox">
...
<form action="admin.php?m=eviladmin&amp;act=user&amp;sid={$sid}&amp;find=1&amp;methode=uniqueid" method="post" name="user" id="user">
  <input type="hidden" id="save" name="save" value="1" />
  <div class="contentbox">
...
{if $do eq "pre-rename"}
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=servergroups&amp;do=rename&amp;sid={$sid}&amp;sgid={$sgid}" method="post" name="user" id="user">
  <input type="hidden" id="save" name="save" value="1" />
  <div class="contentbox">
...
{if $do eq "pre-copy"}
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=servergroups&amp;do=copy&amp;sid={$sid}&amp;sgid={$sgid}" method="post" name="sgcopy">
  <input type="hidden" id="save" name="save" value="1" />
  <div class="contentbox">
...
<div class="contentbox">{foreach from=$servergrouplist item=sg name=sg}
  <div class="contenttable" style="background-color:{cycle values="#f7f7f7,#e2f0f1"};">
    ...
    <div style="float:left; width:145px;"><a class="dark" href="admin.php?m=eviladmin&act=permissionlist&sid={$sid}&sgid={$sg.sgid}"><img src="./templates/{$theme}/images/pencil.png" alt="{$lang.eviladmin_info_edit_perms}" title="{$lang.eviladmin_info_edit_perms}" /></a>&nbsp;&nbsp;&nbsp;<a class="dark" href="admin.php?m=eviladmin&act=servergroups&do=pre-rename&sid={$sid}&sgid={$sg.sgid}"><img src="./templates/{$theme}/images/textfield_rename.png" alt="{$lang.eviladmin_info_edit_sg_name}" title="{$lang.eviladmin_info_edit_sg_name}" /></a>&nbsp;&nbsp;&nbsp;<a class="dark" href="admin.php?m=eviladmin&act=servergroupclients&sid={$sid}&sgid={$sg.sgid}"><img src="./templates/{$theme}/images/user.png" alt="{$lang.eviladmin_info_sg_user}" title="{$lang.eviladmin_info_sg_user}" /></a>&nbsp;&nbsp;&nbsp;<a class="dark" href="admin.php?m=eviladmin&act=servergroups&do=pre-copy&sid={$sid}&sgid={$sg.sgid}"><img src="./templates/{$theme}/images/doc_convert.png" alt="{$lang.eviladmin_info_copy_perm}" title="{$lang.eviladmin_info_copy_perm}" /></a>&nbsp;&nbsp;&nbsp;{if $sg.default_server_group eq "1"}<img src="./templates/{$theme}/images/exclamation.png" alt="{$lang.eviladmin_info_dont_delete}" title="{$lang.eviladmin_info_dont_delete}" />{else}<a class="dark" ondblclick="document.location.href='admin.php?m=eviladmin&act=servergroups&do=delete&sid={$sid}&sgid={$sg.sgid}'" style="cursor:pointer;"><img src="./templates/{$theme}/images/delete.png" alt="{$lang.eviladmin_info_delete_sg}"  title="{$lang.eviladmin_info_delete_sg}" /></a>{/if}</div>
    <div class="clear"> </div>
  </div>
  {/foreach} </div>
<div class="contentbox">
...
<div class="contentspacer"></div>
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=servergroups&amp;do=add&amp;sid={$sid}" method="post" name="user" id="user">
...
<div class="contentspacer"></div>
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=tokenmanager&amp;do=add&amp;sid={$sid}" method="post" name="tokenadd" id="tokenadd">
  <div class="contentbox">
...
{if $do eq "pre-edit"}
<div class="contentspacer"></div>
<form action="admin.php?m=eviladmin&amp;act=permissionlist&amp;do=edit&amp;sid={$sid}&amp;sgid={$sgid}&amp;permid={$permid}#{$permid}" method="post" name="user" id="user">
  <input type="hidden" id="permname" name="permname" value="{$permname}" />
  <div class="contentbox">
