...
$cp_lang['ts3adminhostbanner_gfx'] = "Hostbanner GFX";
...
$cp_lang['ts3admin_upload_message'] = "Hier hochladen";
...
$cp_lang['virtualserver_needed_identity_security_level'] = "Security Level";
$cp_lang['ts3admin_set_new_password'] = "Neues Passwort setzen";
$cp_lang['ts3admin_new_password'] = "Neues Server Passwort";
$cp_lang['ts3admin_userid'] = "User ID";
$cp_lang['servergroup'] = "Server Gruppe";
$cp_lang['ts3admin_id'] = "ID";
$cp_lang['ts3admin_nickname'] = "Nickname";
$cp_lang['ts3admin_group'] = "Gruppe";
$cp_lang['ts3admin_user_created'] = "Benutzer erstellt";
$cp_lang['ts3admin_last_login'] = "Letzter Login";
$cp_lang['ts3admin_status'] = "Status";
$cp_lang['ts3admin_option'] = "Aktion";
$cp_lang['ts3admin_info_user_edit'] = "Benutzer bearbeiten";
$cp_lang['ts3admin_info_user_delete'] = "Benutzer entfernen";
$cp_lang['ts3admin_message'] = "Nachricht";
$cp_lang['ts3admin_db_id'] = "Datenbank ID";
$cp_lang['ts3admin_unqiue_id'] = "Eindeutige ID";
$cp_lang['head_user'] = "Mitglieder";
$cp_lang['ts3admin_name'] = "Name";
$cp_lang['ts3admin_unqie_id'] = "Eindeutige ID";
$cp_lang['ts3admin_info_user_delete_from_sg'] = "Mitglied aus der Server Gruppe entfernen";
$cp_lang['head_edit_name'] = "Name &auml;ndern";
$cp_lang['ts3admin_new_sg_name'] = "Neuer Server Gruppen Name";
$cp_lang['head_copy_perms'] = "Rechte kopieren";
$cp_lang['ts3admin_message_attention'] = "Achtung!";
$cp_lang['ts3admin_text_perm_copy_info'] = "Die Rechte der aktuell ausgewählten Server Gruppe werden nach dem Bestätigen des - <strong>Rechte kopieren!</strong> - Buttons komplett mit den Rechten der unten ausgewählten Server Gruppe überschrieben. Die Rechte der aktuell ausgewählten Server Gruppe können <strong>nicht</strong> wiederhergestellt werden!";
$cp_lang['ts3admin_text_perm_copy_choose'] = "Wähle nun die Gruppe aus der die Rechte für die ausgewählte Gruppe übernommen werden sollen!";
$cp_lang['ts3admin_type'] = "Typ";
$cp_lang['ts3admin_icon_id'] = "Icon ID";
$cp_lang['ts3admin_save_db'] = "Save DB";
$cp_lang['ts3admin_info_edit_perms'] = "Rechte bearbeiten";
$cp_lang['ts3admin_info_edit_sg_name'] = "Server Gruppen Name editieren";
$cp_lang['ts3admin_info_sg_user'] = "Server Gruppen Mitglieder";
$cp_lang['ts3admin_info_copy_perm'] = "Rechte aus vorhandener Server Gruppe übernehmen";
$cp_lang['ts3admin_info_dont_delete'] = "Diese Gruppe kann nicht gel&ouml;scht werden, da dies eine Standartgruppe ist. Sobald diese Gruppe gelöscht wird ist alles kaputt!";
$cp_lang['ts3admin_info_delete_sg'] = "Server Gruppe entfernen";
$cp_lang['ts3admin_sg_name'] = "Server Gruppen Name";
$cp_lang['ts3admin_token'] = "Token";
$cp_lang['ts3admin_channel'] = "Channel";
$cp_lang['ts3admin_channelgroup'] = "Channel Gruppe";
$cp_lang['ts3admin_info_delete_token'] = "Token entfernen";
$cp_lang['ts3admin_channel'] = "Channel";
$cp_lang['ts3admin_dont_allow'] = "Nicht erlauben";
$cp_lang['ts3admin_allow'] = "Erlauben";
$cp_lang['ts3admin_skip'] = "Skip";
$cp_lang['ts3admin_negated'] = "Negated";
$cp_lang['ts3admin_name_desc'] = "Name / Beschreibung";
$cp_lang['ts3admin_value'] = "Wert";
$cp_lang['ts3admin_grant'] = "Vergabe";
$cp_lang['ts3admin_serverid'] = "Server";
$cp_lang['ts3admin_serverid'] = "Server";
$cp_lang['ts3admin_serverid'] = "Server";
