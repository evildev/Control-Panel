...
<title><?php echo $this->_tpl_vars['lang']['adminarea']; ?>
 - <?php echo $this->_tpl_vars['SITE_SITENAME']; ?>
    ...
    <div>
      <div class="header">
        <div class="text">
          ...
          <div class="small"><?php echo $this->_tpl_vars['lang']['adminarea']; ?>
</div>
        </div>
        <div class="welcome"><?php echo $this->_tpl_vars['lang']['welcome']; ?>
 <?php echo $this->_tpl_vars['name']; ?>
!</div>
        <div class="logout"> <a class="darkbg" href="../index.php?m=logout"><?php echo $this->_tpl_vars['lang']['logout']; ?>
</a> </div>
        <div class="panel"> <?php if ($this->_tpl_vars['admin'] == 1): ?> <a class="darkbg" href="../customer/index.php"><?php echo $this->_tpl_vars['lang']['goto_customerarea']; ?>
</a> <?php endif; ?></div>
      </div>
      <!-- Header Ende -->
      <!-- Content -->
      <div id="main" class="tunnel">
        <div id="maincontent" class="maincontent">
          <div class="module">
            <div class="links">
              <div class="theader">
                <div class="bg" style="padding-left:7px;"> <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'navi/admin_navigation.tpl', 'smarty_include_vars' => array()));
