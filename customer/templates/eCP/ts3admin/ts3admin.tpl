...
<div class="contentbox">
  ...
  <div class="contenttext">
    ...
    <script type="text/javascript" src="http://www.evilDEV.de/backend/external/tsviewer.php?serverip={$serverip}&tcpport={$tcpport}&udpport={$virtualserver_port}&mode=3&nolog=1"></script>
      </div>
    <div class="clear">&nbsp;</div>
  </div>
</div>
