...
<title>{$lang.customerarea} - {$SITE_SITENAME} {$location}</title>
...
<script language="Javascript" type="text/javascript" src="../backend/java/info.js"></script>
    ...
    <div>
      <div class="header">
        <div class="text">
          ...
          <div class="small">{$lang.customerarea}</div>
        </div>
        <div class="welcome">{$lang.welcome} {$name}!</div>
        <div class="logout"> <a class="darkbg" href="../index.php?m=logout">{$lang.logout}</a> </div>
        <div class="panel"> {if $admin == 1 } <a class="darkbg" href="../admin/index.php">{$lang.goto_adminarea}</a> {/if}</div>
      </div>
      <!-- Header Ende -->
      <!-- Content -->
      <div id="main" class="tunnel">
        <div id="maincontent" class="maincontent">
          <div class="module">
            <div class="links">
              <div class="theader">
                <div class="bg" style="padding-left:7px;"> {include file='navi/customer_navigation.tpl'}
                  <div class="clear">&nbsp;</div>
                </div>
              </div>
            </div>
