...
{if $vc.typ eq "TS3"}
  ...
  <a class="dark" href="customer.php?m=ts3admin&act=overview&sid={$vc.id}" style="cursor:pointer;"><img src="./templates/{$theme}/images/ts3.jpg" title="Teamspeak 3 Server" alt="Teamspeak 3 Server" hspace="5" vspace="0" border="0" align="left" width="119" height="50" /></a></div>
    <div style="float:left; width:160px; line-height:25px; height:25px; vertical-align: super;"><a class="dark" href="customer.php?m=ts3admin&act=overview&sid={$vc.id}" style="cursor:pointer;">{$vc.serverip}</a></div>
    <div style="float:left; width:120px; line-height:25px; height:25px; vertical-align: super;"><a class="dark" href="customer.php?m=ts3admin&act=overview&sid={$vc.id}" style="cursor:pointer;">{$vc.udpport}</a></div>
